<template>
  <div :class="classes">
    <!-- <h3 class="o1-text-gray-600 dark:o1-text-slate-400 o1-mb-4"><strong>{{ field.name }}</strong></h3> -->
    <NoteInput
      ...
      :placeholder="field.placeholder || __('notesField.defaultPlaceholder')"
    ...
    <div class="o1-flex o1-justify-center o1-mb-3 o1-mt-3" v-if="hasMoreToShow">
      <DefaultButton style="height: 24px; line-height: 24px" @click="maxToShow = void 0">
        ...
        {{ __('notesField.showMoreNotes', { hiddenNoteCount: String(notes.length - maxToShow) }) }}
      </DefaultButton>
    </div>
  ...
  computed: {
    ...
    classes() {
      const defaultClasses =
        'notes-field dark:o1-bg-slate-800 o1-px-4 o1-pt-4 o1-pb-2 b-none o1-rounded-b-lg o1-overflow-hidden o1-border-white dark:o1-border-gray-700';
